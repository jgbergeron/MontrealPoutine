    ...
    @IBInspectable public var fullImage: UIImage? {
        didSet {
            ...
            for imageView in self.fullImageViews {
                ...
                //println("Contenu de imageView \(imageView)")
                switch i//
                {
                case 1:
                    imageView.image = UIImage(named: "StarRouge")
                case 2:
                    imageView.image = UIImage(named: "StarJaune")
                case 3:
                    imageView.image = UIImage(named: "StarJaune")
                case 4:
                    imageView.image = UIImage(named: "StarVert")
                case 5:
                    imageView.image = UIImage(named: "StarVert")
                default:
                    imageView.image = emptyImage
    ...
    override public func layoutSubviews() {
        ...
        if let emptyImage = self.emptyImage {
            ...
            for i in 0..<self.maxRating {
                ...
                case 2:
                    imageView = self.emptyImageViews[i]
    ...
    func initImageViews() {
        ...
        for i in 0..<self.maxRating {
            ...
            case 0:
                fullImageView.image = self.fullImage
            case 1:
                fullImageView.image = self.emptyImage
            case 2:
                fullImageView.image = self.fullImage
            case 3:
                fullImageView.image = self.emptyImage
